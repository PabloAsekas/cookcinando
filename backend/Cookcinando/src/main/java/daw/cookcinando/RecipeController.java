...
public class RecipeController {
	...
	public String verReceta(Model model, @PathVariable long id) {
		...
		List<Recipe> recomendadas = new ArrayList<>();
		for (long i = 0; i < 3; i++) {
